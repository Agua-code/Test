...
public class Graphcolor  {
    ...
    int Stu_Class[]= null;
    int Key_Stu_ID[]= null;
    int Key_Stu_Class[]= null;
    ArrayList<String> Stu_Course= null;
    ArrayList<String> Key_Stu_Move_Course= null;
    ArrayList<String> Key_Stu_Course= null;
    //走一课数据结构
    ArrayList<String> Course_Move1= null;//走一的课名字
    int ZBK_Num = 0;
    int ZBK[][]= null;
    int ZBK_C[]= null;
    int ZB_Class_Set[]= null;
    int ZB_Stu_Set[]= null;
    int ZB_Tea_Set[]= null;
    int CM = 0;
    //选考课数据结构
    ...
    public Graphcolor() throws IOException {
        read_data1();//第一次输入
        int i, j, k, l, m;
        ...
        ZB_Class_Set = new int[Class_Num * Class_Num];
    ...
    public void read_data1() throws IOException{
        ...
        //读取第一个文件
        File Filename1 = new File("C:\\Users\\18367\\IdeaProjects\\PK\\src\\ZBPK\\kebiao.csv");
        ...
        for (i = 0; i <= Tea_Num; i++)
            Tct[i] = 1;
        //读取第二个文件
        File Filename2 = new File("C:\\Users\\18367\\IdeaProjects\\PK\\src\\ZBPK\\data_kebiao.txt");
    ...
    public void read_data2()throws IOException{
        ...
        //走班
        File Filename3 = new File("C:\\Users\\18367\\IdeaProjects\\PK\\src\\ZBPK\\Output4.csv");
        BufferedReader inFile = null;
        ...
        Stu_Num = 0;
        Key_Stu_Num = 0;
        File Filename4 = new File("C:\\Users\\18367\\IdeaProjects\\PK\\src\\ZBPK\\stu_data.csv");
        BufferedReader inFile_stu = null;
        in = new FileInputStream(Filename4);
        // 指定读取文件时以UTF-8的格式读取
    ...
    public void set_ZB(){
        ...
        for (bn = 1; bn <ZBK_Num; bn++)
        {
            ...
            Class_Crs_Num[l][k] = 0;//把课时设为0了
            ZB_Class_Set[bn * 2 + 1] = m;
            ZB_Class_Set[bn * 2 + 2] = l;
            ZB_Tea_Set[bn + 1] = Class_Tea[l][k];
        }
        ZB_Class_Set[0] = ZBK_Num * 2;
        ...
        for (i = 2; i <= ZBK_Num * 2; i++)
        {
            for (j = 1; j < i; j++)
            {
                if (ZB_Class_Set[i] == ZB_Class_Set[j])
                {
                    ZB_Class_Set[i] = 0;
                }
            }
            ...
            for (gcr = 1; gcr <= Crs_Num; gcr++)
            {
                if (Class_Crs_Num[gcls][gcr]>0)
                {
                    ...
                    if (nt == 0)
                    {
                        ...
                        LTK_Week[l] = 0;
                        Crs_Attri[l] = 0;
                        if (Coursename.get(gcls-1)=="语文" || Coursename.get(gcls-1) == "数学" || Coursename.get(gcls-1) == "英语")
                            Crs_Attri[l] = 1;//一等课
                        if ((nl == 2) && (Weak_Day >= 4))
	...
	*/
    ...
    public int Get_Initial_solution(int search_depth){
        ...
        for (iter = 1; iter <= search_depth; iter++)
        {
            ...
            {
                if (Node_Tea_Sign[x] != -2 && MCrs[Par[x]] != CM && YPK[x] == 0)
	...
	*/
    ...
    public void out_put_file(){
        ...
        File Filename5 = new File("C:\\Users\\18367\\IdeaProjects\\PK\\src\\ZBPK\\time_class.csv");
        ...
        File Filename6 = new File("C:\\Users\\18367\\IdeaProjects\\PK\\src\\ZBPK\\time_teacher.csv");
        ...
        File Filename7 = new File("C:\\Users\\18367\\IdeaProjects\\PK\\src\\ZBPK\\time_stu.csv");
    ...
    public void to_json(){
        ...
        v=v/7;
        File Filename8 = new File("C:\\Users\\18367\\IdeaProjects\\PK\\src\\ZBPK\\result1.json");
        BufferedWriter outFile = null;
        try{
        ...
        File Filename9 = new File("C:\\Users\\18367\\IdeaProjects\\PK\\src\\ZBPK\\result2.json");//不排课时间、课程
        BufferedWriter outFile1 = null;
        try {
    ...
    public static void main(String[] args) throws IOException {
        ...
        Graphcolor graph = new Graphcolor();
        graph.check_kc();
        graph.check_HBK();
        graph.set_HB();//设置合班课
        graph.set_XK();//设置选考课
