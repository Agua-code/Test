...
public class BasicDataInfo {
     ...
     */
    private int XKNum;
    private List<XKListInfo> xkListInfo;

    /**
     *学生信息
     */
    private List<StuDataInfo> stuDataInfoList;
    ...
    public List<Integer> getTeaID() {
        return teaID;
    }

    public void setTeaID(List<Integer> teaID) {
        this.teaID = teaID;
    }
    ...
    public List<XKListInfo> getXkListInfo() {
        return xkListInfo;
    }

    public void setXkListInfo(List<XKListInfo> xkListInfo) {
        this.xkListInfo = xkListInfo;
    }

    public List<StuDataInfo> getStuDataInfoList() {
        return stuDataInfoList;
    }

    public void setStuDataInfoList(List<StuDataInfo> stuDataInfoList) {
        this.stuDataInfoList = stuDataInfoList;
    }
}
